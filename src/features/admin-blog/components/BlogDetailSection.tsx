...
import { getBlogsById } from "../services/get-blogs";
import { BlogDetail } from "../../blog/components/blog-detail";
...
export default function BlogDetailPage({ params }: Props) {
  ...
  useEffect(() => {
    const loadBlog = async () => {
      ...
      const foundBlog = getBlogsById(id);
