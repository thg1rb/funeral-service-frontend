...
export const INITIAL_ORDERS: (Order & { orderId: string })[] = [
  {
    ...
    status: OrderStatus.INPROGRESS, // เพิ่มสถานะ
    customerDetails: {
      name: "คุณสมชาย รักดี",
      phone: "081-234-5678",
  ...
  },
  {
    ...
    status: OrderStatus.PENDING, // เพิ่มสถานะ
    customerDetails: {
  ...
  {
    orderId: "f9e8d7c6-b5a4-4321-abcd-ef0987654321",
    status: OrderStatus.COMPLETE, // เพิ่มสถานะ
    customerDetails: {
    ...
    items: [
      {
        ...
        item: {
          ...
          description: "เบเกอรี่อบสด 2 ชิ้น + นำผลไม้ 1 กล่อง",
          deletedAt: null,
          maxQuantity: 300
        }
      }
